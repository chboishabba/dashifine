...
- Orbit profile tables regenerated with signed block permutations (Sp×Sq, sign flips), shells |Q|=1,2:
  ...
  - Key outputs (top sizes):
    - p=1,q=2: shell1 sizes [8,4,2]; shell2 sizes [1,1,1,1].
    - p=2,q=1: shell1 sizes [8,4,2]; shell2 sizes [1,1,1,1].
    - p=3,q=1: shell1 sizes [24,6,2]; shell2 sizes [1,1,1,1,1] (28 orbits).
    - p=4,q=0: shell1 sizes [8]; shell2 sizes [1,1,1,1,1] (24 orbits).
    - p=2,q=2: shell1 sizes [16,16,4,4]; shell2 sizes [1,1,1,1,1] (8 orbits).
    - p=1,q=3: shell1 sizes [24,6,2]; shell2 sizes [1,1,1,1,1] (28 orbits).
    - p=0,q=4: shell1 sizes [8]; shell2 sizes [1,1,1,1,1] (24 orbits).
