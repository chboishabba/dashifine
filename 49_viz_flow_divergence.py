#!/usr/bin/env python3
"""
49_viz_flow_divergence.py

Compute divergence of the averaged flow field in PCA embedding space.
Outputs a heatmap of ∇·v over the grid.
"""
...
def main() -> None:
    ...
    ap.add_argument("--out", default="viz_flow_divergence.png")
    ...
    im = ax.imshow(div, origin="lower", extent=[x_min, x_max, y_min, y_max], cmap="coolwarm")
    ax.set_title("Flow Divergence (∇·v)")
    ax.set_xlabel("PC1")
    ax.set_ylabel("PC2")
